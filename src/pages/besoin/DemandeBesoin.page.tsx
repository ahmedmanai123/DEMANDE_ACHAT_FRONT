...
const DemandeBesoinPage: React.FC = () => {
  ...
  const { data, total, loading, filter, updateFilter, changePage, exportExcel } =
    useBesoinList();
  ...
  return (
    ...
    <div className="page-wrapper">
      ...
      <div className="page-breadcrumb">
        <Breadcrumb
          items={[
            { href: "/", title: <><HomeOutlined /> Accueil</> },
        ...
        <div className="card">
          <div className="card-body">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              ...
              {can("Demande_Besoin", "Creer") && (
                <Button
                  type="primary"
                  icon={<PlusOutlined />}
                  onClick={() => navigate("/besoin/nouveau")}
                >
                  Nouveau
                </Button>
              )}
              ...
              {can("Demande_Besoin", "Consulter") && (
                <Button
                  ...
                  onClick={() => {
                    if (selectedRowKey)
                      navigate(`/besoin/details/${selectedRowKey}`);
                  }}
                >
                  Détails
                </Button>
            ...
            <Table<DA_BESOINDto>
              ...
              scroll={{ x: 900 }}
              rowClassName={(record) =>
                record.B_No === selectedRowKey ? "selected-row" : ""
              }
              onRow={(record) => ({
