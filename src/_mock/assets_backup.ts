...
export const DB_MENU: Menu[] = [
	...
	},
	{
		id: "besoins",
		parentId: "group_dashboard",
		name: "sys.nav.besoins",
		code: "besoins",
		icon: "solar:box-bold-duotone",
		type: MENU,
		path: "/besoins",
		component: "/pages/besoin",
	},
	{
		id: "besoin-types",
		parentId: "group_dashboard",
		name: "Types de besoin",
		code: "besoin-types",
		icon: "solar:document-bold-duotone",
		type: MENU,
		path: "/besoin-types",
		component: "/pages/besoin/components/BesoinTypePage",
	},
	{
		id: "parametres",
		parentId: "group_dashboard",
	...
	{
		id: "account_users_list",
		parentId: "account_users",
		name: "Liste des utilisateurs",
		code: "account:users:list",
		type: MENU,
		path: "/account/users",
		component: "/pages/sys/account/UsersPage",
	},
	{
		id: "account_users_new",
		parentId: "account_users",
		name: "Nouveau utilisateur",
		code: "account:users:new",
		type: MENU,
		path: "/account/users/new",
		component: "/pages/sys/account/UserForm",
	},
	{
		id: "account_users_edit",
		parentId: "account_users",
		name: "Modifier utilisateur",
		code: "account:users:edit",
		type: MENU,
